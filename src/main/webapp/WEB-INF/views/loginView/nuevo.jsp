...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <h2 class="text-center">Se le enviará un código al correo para comprobar su identidad</h2>
            <form action="<c:url value='/Login/sendEmail' />" method="post" onsubmit="return validarFormulario()" class="mt-4">
